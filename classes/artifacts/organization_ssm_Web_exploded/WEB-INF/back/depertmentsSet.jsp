		...
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					<div class="content">
						<table>
							<c:forEach items="${Depertment1 }" var="Depertment1">
								<tr>
									<td>${Depertment1.id }</td>
									<td>${Depertment1.apellation }</td>
									<td>${Depertment1.introduce }</td>
									<td><a
										href="${pageContext.request.contextPath }/deDepertment.action?id=${Depertment1.id }">删除</a></td>
								</tr>
							</c:forEach>
						</table>
						<form
							action="${pageContext.request.contextPath }/addDepertment.action"
							method="post" enctype="multipart/form-data">
							<h2>部门信息</h2>
							<table>
								<tr>
									<td>部门名称</td>
									<td><input type="text" name="apellation" /></td>
								</tr>
							</table>
							<h2>部门描述</h2>
							<div id="wangeditor1" class="text"></div>
							<input id="text1" name="introduce" style="display:none"></input>

          ...
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <div class="section-title">
                         <h3>部门展示</h3>
                         <h2>在这里你能看到每个部门的特点，能让你身上的闪光点更加闪耀.</h2>
                    </div>
				<c:forEach items="${Depertment1 }" var="Depertment1">
                    <div class="blog-post-thumb">
                         ...
                         <div class="blog-post-title">
                              <h3>${Depertment1.apellation }</h3>
                         </div>
                      

                         <div class="blog-post-des">
                              <p>部门介绍：</p>
                              <p>${Depertment1.introduce }</p>
                              <a href="${pageContext.request.contextPath }/register.action" class="btn btn-default">Join Us</a>
                         </div>
                    </div>
			</c:forEach>
               </div>

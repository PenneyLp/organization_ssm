...
<body>
			...
			<div class="row">
				...
				<div class="span9">
					<div class="content">
						...
						<form
							action="${pageContext.request.contextPath }/updateHomeChar.action"
							method="post" enctype="multipart/form-data">
							<h3>主页中间文字：</h3>
							<div id="wangeditor1" class="text">
							
							</div>
							<input id="text1" name="text" style="display:none"></input>
							<h3>主页最后的文字：</h3>
							<div id="wangeditor2">
								
							</div>
							<input id="text2" name="last" style="display:none"></input>
	...
	<script type="text/javascript">
		...
		var editor2 = new W('#wangeditor2');
		// 或者 var editor = new E( document.getElementById('#editor') )
		// 自定义菜单配置
		editor2.customConfig.menus = [ 'head', // 标题
		'bold', // 粗体
		'italic', // 斜体
		'underline', // 下划线
		'strikeThrough', // 删除线
